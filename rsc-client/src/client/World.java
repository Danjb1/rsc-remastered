...
public class World {
    ...
    private void doLoadRegion(int x, int y, int height) {
        ...
        wallModels[height] = tmpModel.createModelArray(0, 0, 1536, 1536, 8, 64, 338, true);
        for (int l2 = 0; l2 < 64; l2++) {
            scene.addModel(wallModels[height][l2]);
        }
    }
