...
/**
 * The {@link PacketManager} class is the central hub for all packet
 * based logic, this class contains purely static methods that will
 * handle the setup and construction of each individual packet detected
 * by the server.
 */
